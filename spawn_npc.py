...
def main():
    ...
    try:
        ...
        world, vehicles_list, walkers_list, all_id, all_actors = spawn_vehicles_and_walkers(
            client, args.number_of_vehicles, args.number_of_walkers, args.filterv, args.filterw, args.safe)
